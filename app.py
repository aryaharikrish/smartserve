...
app = Flask(__name__)
app.secret_key = os.getenv("SECRET_KEY", "smartserve_default_secret")
...
def login():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return render_template("auth/login.html", error=f"Database Error ({type(e).__name__}): Please check your MONGO_URI in .env")
